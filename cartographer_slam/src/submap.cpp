...
std::unique_ptr<::cartographer::io::SubmapTextures> FetchSubmapTextures(
    ...
    rclcpp::Client<cartographer_slam::srv::SubmapQuery>::SharedPtr client,
    rclcpp::executors::SingleThreadedExecutor::SharedPtr callback_group_executor,
    const std::chrono::milliseconds timeout)
{
  auto request = std::make_shared<cartographer_slam::srv::SubmapQuery::Request>();
  ...
  if (result->status.code != ::cartographer_slam::msg::StatusCode::OK ||
