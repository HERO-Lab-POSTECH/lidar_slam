...
cartographer_slam::msg::Metric Histogram::ToRosMessage() {
  cartographer_slam::msg::Metric msg;
  msg.type = cartographer_slam::msg::Metric::TYPE_HISTOGRAM;
  ...
  for (const auto& bucket : CountsByBucket()) {
    cartographer_slam::msg::HistogramBucket bucket_msg;
