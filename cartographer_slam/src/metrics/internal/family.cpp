...
cartographer_slam::msg::MetricFamily CounterFamily::ToRosMessage() {
  cartographer_slam::msg::MetricFamily family_msg;
...
cartographer_slam::msg::MetricFamily GaugeFamily::ToRosMessage() {
  cartographer_slam::msg::MetricFamily family_msg;
  family_msg.name = name_;
  family_msg.description = description_;
  for (const auto& wrapper : wrappers_) {
...
cartographer_slam::msg::MetricFamily HistogramFamily::ToRosMessage() {
  cartographer_slam::msg::MetricFamily family_msg;
  family_msg.name = name_;
  family_msg.description = description_;
  for (const auto& wrapper : wrappers_) {
