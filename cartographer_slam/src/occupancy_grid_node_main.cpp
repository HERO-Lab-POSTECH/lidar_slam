...
#include "cartographer_slam/submap.h"
...
class Node : public rclcpp::Node
{
 ...
 private:
  void HandleSubmapList(const cartographer_slam::msg::SubmapList::ConstSharedPtr& msg);
  void DrawAndPublish();
  ...
  ::rclcpp::Client<cartographer_slam::srv::SubmapQuery>::SharedPtr client_ GUARDED_BY(mutex_);
  ::rclcpp::Subscription<cartographer_slam::msg::SubmapList>::SharedPtr submap_list_subscriber_ GUARDED_BY(mutex_);
      ...
      resolution_(resolution)
{
  ...
  client_ = this->create_client<cartographer_slam::srv::SubmapQuery>(
  ...
  auto handleSubmapList =
    [this, publish_period_sec](const typename cartographer_slam::msg::SubmapList::SharedPtr msg) -> void
    {
    absl::MutexLock locker(&mutex_);

    // We do not do any work if nobody listens.
    if (this->count_publishers(kSubmapsTopic) == 0){
      return;
    }
  ...
  submap_list_subscriber_ = create_subscription<cartographer_slam::msg::SubmapList>(
    kSubmapsTopic, rclcpp::QoS(10), handleSubmapList);
}
