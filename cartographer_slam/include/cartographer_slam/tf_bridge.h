...
#ifndef CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_TF_BRIDGE_H
#define CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_TF_BRIDGE_H
...
#endif  // CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_TF_BRIDGE_H
