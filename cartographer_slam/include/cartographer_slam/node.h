...
#ifndef CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_NODE_H
#define CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_NODE_H
...
#include "cartographer_slam/map_builder_bridge.h"
...
#include "cartographer_slam/trajectory_options.h"
#include "cartographer_slam/srv/finish_trajectory.hpp"
#include "cartographer_slam/srv/get_trajectory_states.hpp"
#include "cartographer_slam/srv/read_metrics.hpp"
#include "cartographer_slam/srv/start_trajectory.hpp"
#include "cartographer_slam/msg/status_response.hpp"
#include "cartographer_slam/msg/submap_entry.hpp"
#include "cartographer_slam/msg/submap_list.hpp"
#include "cartographer_slam/srv/submap_query.hpp"
#include "cartographer_slam/srv/write_state.hpp"
...
class Node {
 public:
  ...
  void HandleLivoxPointsMessage(int trajectory_id, const std::string& sensor_id,
 ...
 private:
  ...
  bool handleReadMetrics(const cartographer_slam::srv::ReadMetrics::Request::SharedPtr,
  ...
  cartographer_slam::msg::StatusResponse FinishTrajectoryUnderLock(
  ...
  cartographer_slam::msg::StatusResponse TrajectoryStateToStatus(
      int trajectory_id,
      const std::set<
  ...
  ::rclcpp::Publisher<::cartographer_slam::msg::SubmapList>::SharedPtr submap_list_publisher_;
  ...
  ::rclcpp::Service<cartographer_slam::srv::SubmapQuery>::SharedPtr submap_query_server_;
  ::rclcpp::Service<cartographer_slam::srv::TrajectoryQuery>::SharedPtr trajectory_query_server;
  ::rclcpp::Service<cartographer_slam::srv::StartTrajectory>::SharedPtr start_trajectory_server_;
  ::rclcpp::Service<cartographer_slam::srv::FinishTrajectory>::SharedPtr finish_trajectory_server_;
  ::rclcpp::Service<cartographer_slam::srv::WriteState>::SharedPtr write_state_server_;
  ::rclcpp::Service<cartographer_slam::srv::GetTrajectoryStates>::SharedPtr get_trajectory_states_server_;
  ::rclcpp::Service<cartographer_slam::srv::ReadMetrics>::SharedPtr read_metrics_server_;
...
#endif  // CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_NODE_H
