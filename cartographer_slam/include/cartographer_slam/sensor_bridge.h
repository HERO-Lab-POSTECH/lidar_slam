...
#ifndef CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_SENSOR_BRIDGE_H
#define CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_SENSOR_BRIDGE_H
...
#include "cartographer_slam/msg/landmark_list.hpp"
...
class SensorBridge {
 public:
  ...
  void HandleLivoxPointsMessage(const std::string& sensor_id,
...
#endif  // CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_SENSOR_BRIDGE_H
