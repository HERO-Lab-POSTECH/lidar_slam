...
#ifndef CARTOGRAPHER_SLAM_METRICS_INTERNAL_HISTOGRAM_H
#define CARTOGRAPHER_SLAM_METRICS_INTERNAL_HISTOGRAM_H
...
#endif  // CARTOGRAPHER_SLAM_METRICS_INTERNAL_HISTOGRAM_H
