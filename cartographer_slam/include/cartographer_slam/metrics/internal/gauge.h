...
#ifndef CARTOGRAPHER_SLAM_METRICS_INTERNAL_GAUGE_H
#define CARTOGRAPHER_SLAM_METRICS_INTERNAL_GAUGE_H
...
class Gauge : public ::cartographer::metrics::Gauge {
 public:
  ...
  cartographer_slam::msg::Metric ToRosMessage() {
    cartographer_slam::msg::Metric msg;
    msg.type = cartographer_slam::msg::Metric::TYPE_GAUGE;
    for (const auto& label : labels_) {
      cartographer_slam::msg::MetricLabel label_msg;
...
#endif  // CARTOGRAPHER_SLAM_METRICS_INTERNAL_GAUGE_H
