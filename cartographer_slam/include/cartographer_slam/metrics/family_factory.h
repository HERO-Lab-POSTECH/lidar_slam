...
#ifndef CARTOGRAPHER_SLAM_METRICS_FAMILY_FACTORY_H
#define CARTOGRAPHER_SLAM_METRICS_FAMILY_FACTORY_H

#include <memory>
#include <string>

#include "cartographer/metrics/family_factory.h"
#include "cartographer_slam/metrics/internal/counter.h"
#include "cartographer_slam/metrics/internal/family.h"
#include "cartographer_slam/metrics/internal/gauge.h"
#include "cartographer_slam/metrics/internal/histogram.h"
...
class FamilyFactory : public ::cartographer::metrics::FamilyFactory {
 public:
  ...
  void ReadMetrics(
      cartographer_slam::srv::ReadMetrics::Response::SharedPtr response) const;
...
#endif  // CARTOGRAPHER_SLAM_METRICS_FAMILY_FACTORY_H
