...
#ifndef CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_ROS_MAP_H
#define CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_ROS_MAP_H
...
#endif  // CARTOGRAPHER_SLAM_CARTOGRAPHER_SLAM_ROS_MAP_H
